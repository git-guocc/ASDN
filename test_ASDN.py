...
def main(noise):
    ...
    for resolution in args.resolutions:
        ...
        # Model
        model = DenoiseNetCD.load_from_checkpoint(args.ckpt)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt', type=str, default='logs/DPUNet_2024_07_11__10_27_43/denoisenet-epoch259-val_loss0.000247.ckpt')
    ...
    parser.add_argument('--resolutions', type=str_list, default=['10000_poisson']) # Set your test resolution
